...
struct UserDTO {
    ...
    2: string NickName (go.tag = 'gorm:"nick_name" redis:"nick_name" form:"nickName" json:"nickName" query:"nickName"')
    3: string icon (go.tag = 'gorm:"icon" redis:"icon"')
}
...
service UserService {
    ...
    UserDTO UserNum(1: Empty request) (api.get="/user/:id")
